...
class DenoiseActor(nn.Module):
    ...
    def encode_inputs(self, visible_rgb, visible_pcd, instruction,
        ...
        if self.use_instruction:
            ...
            instr_pos = curr_gripper[:, -1:, :3].repeat(1, instr_feats.size(1), 1)
        ...
        return (
            ...
            instr_feats, instr_pos,  # language features
...
class TransformerHead(nn.Module):
    ...
    def forward(self, trajectory, timestep,
                context_feats, context, instr_feats, instr_pos,
                adaln_gripper_feats,
                fps_feats, fps_pos):
        """
        Arguments:
            ...
            instr_pos: (B, max_instruction_length, 3)
    ...
    def prediction_head(self,
        ...
        features = torch.cat([gripper_features, sampled_context_features, instr_feats.transpose(0, 1)], 0)
        rel_pos = torch.cat([rel_gripper_pos, sampled_rel_context_pos, rel_instr_pos], 1)
