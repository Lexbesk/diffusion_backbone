...
class BimanualDenoiseActor(nn.Module):
    ...
    def _encode_inputs(self, visible_rgb, visible_pcd, instruction,
                      curr_gripper):
    ...
    def encode_inputs(self, visible_rgb, visible_pcd, instruction,
                      curr_gripper):
        fixed_inputs = self._encode_inputs(
        ...
        return (curr_gripper, context_feats, instr_feats,
                adaln_gripper_feats)
...
class TransformerHead(nn.Module):
    ...
    def forward(self, trajectory_feats, trajectory, timestep,
                context_feats, instr_feats, adaln_gripper_feats):
        """
        Arguments:
