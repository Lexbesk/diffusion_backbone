...
class SingleArmDiffuserActor(DiffuserActor):
    ...
    def __init__(self,
        ...
        self.prediction_head = SingleArmDiffusionHead(
            embedding_dim=embedding_dim,
            use_instruction=use_instruction,
            rotation_parametrization=rotation_parametrization,
            nhist=nhist,
...
class SingleArmDiffusionHead(DiffusionHead):
