...
class DexSampleDataset(Dataset):
    ...
    def init_train(self, mode):
        ...
        print(self.obj_id_lst, 'obj_id_lst')
        ...
        for grasp_type in self.grasp_type_lst:
            ...
            for obj_id in self.obj_id_lst:
                ...
                print(obj_id, obj_grasp_data, 'obj_id and obj_grasp_data')
                if obj_grasp_data == 0:
                    continue
    ...
    def __getitem__(self, idx: int):
        ...
        print('scale: ', scene_scale * scene_cfg["scene"][scene_cfg["task"]["obj_name"]]["scale"][0])
