# main_dir=DEXONOMY_type10_pcdcentric
main_dir=DEXONOMY_7k_pcdcentric

DATA_PATH="/data/user_data/austinz/Robots/manipulation"

# train_data_dir=$DATA_PATH/zarr_datasets/Dexonomy_zarr_type10/train.zarr
# eval_data_dir=$DATA_PATH/zarr_datasets/Dexonomy_zarr_type10/val.zarr
...
run_log_dir=run_Jul13_$model_type-$dataset-lr$lr-$lr_scheduler-$denoise_model-B$B-Bval$B_val-DT$denoise_timesteps
checkpoint=train_logs/${main_dir}/${run_log_dir}/last.pth

# resume new parameters
lr=1e-5
ngpus=4
