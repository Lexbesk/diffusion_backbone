...
nhist=4
nfuture=4
K=32 # number of timesteps sampled per episode during training
...
run_log_dir=run_Sep5-1-B$B-lv2bs$lv2_batch_size-Bval$B_val-DT$denoise_timesteps-nhist$nhist-nfuture$nfuture-K$K-numlayers${num_shared_attn_layers}-embedding_dim$embedding_dim
checkpoint=train_logs/${main_dir}/${run_log_dir}/last.pth

run_log_dir=run_Sep5-10:31pm-B1-lv2bs1-Bval64-DT10-nhist4-nfuture4-K32-numlayers10-embedding_dim256
checkpoint=train_logs/DexterousAct_debug/run_Sep5-10:31pm-B1-lv2bs1-Bval64-DT10-nhist4-nfuture4-K32-numlayers10-embedding_dim256/last.pth
