...
train_data_dir=$DATA_PATH/zarr_datasets/Peract2_dense_zarr/train_rechunked4.zarr
eval_data_dir=$DATA_PATH/zarr_datasets/Peract2_zarr/val_rechunked4.zarr
train_instructions=instructions/peract2/instructions.json
val_instructions=instructions/peract2/instructions.json

dataset=Peract2_3dfront_2dwrist
num_workers=4
memory_limit=6
B=64
B_val=64
...
model_type=denoise3d_2dwrist  # denoise3ddf
bimanual=true
keypose_only=true
