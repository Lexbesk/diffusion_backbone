...
class bi_3dda_node(Node):
    ...
    def SyncCallback(self, bgr, depth):
        ...
        left_hand_transform_7D = np.array([0.2276, 0.2340, 0.1411, -0.0114, 0.1791, -0.3982, 0.8995])
        right_hand_transform_7D = np.array([0.2800, -0.2464, 0.2340, 0.0893, 0.3559, 0.2333, 0.9004])

        curr_gripper[0,0,0,0:7] = left_hand_transform_7D
        curr_gripper[0,0,0,7] = 0.0

        curr_gripper[0,0,1,0:7] = right_hand_transform_7D
        curr_gripper[0,0,1,7] = 0.0
